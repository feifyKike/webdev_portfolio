<template>
    <nav>
      <div class="flex flex-wrap items-center justify-between p-4">
        <img src="../assets/images/signature_logo.png" height="112.6" width="196" class="drop-shadow-md">
        ...
        <div class="hidden w-full lg:block lg:w-auto items-center" id="navbar-default">
          <ul class="font-medium flex flex-col p-4 lg:p-0 mt-4 border border-gray-100 bg-gray-50 lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0">
            <li>
              <a href="#" class="block py-2 pl-3 pr-4" aria-current="page">About</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" class="block bg-gray-300 py-2 px-6 drop-shadow-md">Resume</a>
            </li>
          </ul>
        </div>
      </div>
